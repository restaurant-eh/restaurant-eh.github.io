...
fetch("/XML/Speisen/suppen.xml")
    ...
    .then(xml => {
        ...
        const kaltes = xml.getElementsByTagName("kaltes")[0].getElementsByTagName("suppe")
        ...
        const warmes = xml.getElementsByTagName("warmes")[0].getElementsByTagName("suppe")
